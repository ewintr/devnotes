...
After writing https://erikwinter.nl/articles/2021/simple-log-file-analysis-for-your-kubernetes-pods-on-the-command-line/[my tutorial on analysis of JSON structured logs on the command line] I realized I could apply the same solution for website statistics. If only I could make Nginx to log in the same format.
